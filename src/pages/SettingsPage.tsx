    ...
    <div className="space-y-4 p-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="space-y-3 p-5">
          ...
          <p className="text-xs text-[#6d614c]">
            Подставляются в новый рейс. Километраж считается по грузовому профилю Valhalla (фура, дороги с доступом HGV),
            пункты — OSM Photon / Nominatim. Если карта недоступна — запасной расчёт по прямой × 1,25.
          </p>
